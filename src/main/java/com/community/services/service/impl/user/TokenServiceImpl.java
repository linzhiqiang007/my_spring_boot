...
import com.community.services.mapper.user.TokenMapper;
...
import com.community.services.utils.DefaultValue;
import com.community.services.utils.MD5Util;
...
public class TokenServiceImpl implements TokenService {
	...
	public Token findTokenByUsername(String username) {
		...
		TokenExample.Criteria createCriteria = example.createCriteria();
